...
const ja: Dictionary = {
  ...
  'app.footer3': '音源サンプル: FluidR3_GM (CC BY 3.0)',
  'app.footer.etymology': '※ Vertere という名前は、ラテン語の「vertere（ひっくり返す、変換する：convert 等の語源）」に由来しています。',
  'step1.label': 'Step 1',
...
const en: Dictionary = {
  ...
  'app.footer3': 'Sound samples: FluidR3_GM (CC BY 3.0)',
  'app.footer.etymology': '* The name "Vertere" comes from the Latin word "vertere" (to turn, convert).',
  'step1.label': 'Step 1',
